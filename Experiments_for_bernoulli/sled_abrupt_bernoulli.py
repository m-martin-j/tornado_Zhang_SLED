...
true_change_training = [i for i in range(5000, 2000000, 10000)]
for c in true_change_training:
    for j in range(500):
        data_stream_training[c + j + 1] = np.random.binomial(n=1, p=0.2+0.4/500 * (j + 1), size=1)[0]
...
f = open('sled_abrupt_bernoulli','a')
