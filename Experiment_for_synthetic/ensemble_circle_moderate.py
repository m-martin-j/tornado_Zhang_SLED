...
stream_name = "circle"
project = Project("projects/single", "ensemble_circle_moderate_training/" + stream_name)

# 2. Generating training stream
project_path = "data_streams/ensemble_circle_moderate_training/" + stream_name + "/"
...
stream_name = "circle"
project = Project("projects/single", "ensemble_circle_moderate_detection/"+ stream_name)

# 2.Generating detection stream
project_path = "data_streams/ensemble_circle_moderate_detection/" + stream_name + "/"
if not os.path.exists(project_path):
    os.makedirs(project_path)
...
f = open('ensemble_circle_moderate', 'a')
