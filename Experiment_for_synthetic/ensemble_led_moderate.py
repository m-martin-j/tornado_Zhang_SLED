...
stream_name = "led"
project = Project("projects/single", "ensemble_led_moderate_training/" + stream_name)

# 2. Generating training stream
project_path = "data_streams/ensemble_led_moderate_training/" + stream_name + "/"
...
stream_name = "led"
project = Project("projects/single", "ensemble_led_moderate_detection/"+ stream_name)

# 2.Generating detection stream
project_path = "data_streams/ensemble_led_moderate_detection/" + stream_name + "/"
if not os.path.exists(project_path):
    os.makedirs(project_path)
...
f = open('ensemble_led_moderate', 'a')
