...
stream_name = "circle"
project = Project("projects/single", "ensemble_circle_gradual_training/" + stream_name)

# 2. Generating training stream
project_path = "data_streams/ensemble_circle_gradual_training/" + stream_name + "/"
...
stream_generator = CIRCLES(concept_length=5000, noise_rate=0.1, transition_length=800, thresholds=thresholds)
...
stream_name = "circle"
project = Project("projects/single", "ensemble_circle_gradual_detection/"+ stream_name)

# 2.Generating detection stream
project_path = "data_streams/ensemble_circle_gradual_detection/" + stream_name + "/"
if not os.path.exists(project_path):
    os.makedirs(project_path)
...
f = open('ensemble_circle_gradual', 'a')
