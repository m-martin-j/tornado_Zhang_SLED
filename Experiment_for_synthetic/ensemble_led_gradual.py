...
stream_name = "led"
project = Project("projects/single", "ensemble_led_gradual_training/" + stream_name)

# 2. Generating training stream
project_path = "data_streams/ensemble_led_gradual_training/" + stream_name + "/"
...
sled.train(smoothing_factor=0.5, fusion_parameter=0.5, drift_acceptance_interval=1000, detected_drifts=detected_drift,
...
stream_name = "led"
project = Project("projects/single", "ensemble_led_gradual_detection/"+ stream_name)

# 2.Generating detection stream
project_path = "data_streams/ensemble_led_gradual_detection/" + stream_name + "/"
if not os.path.exists(project_path):
    os.makedirs(project_path)
