...
project = Project("projects/single", "base_detector_sine1_gradual_dde/"+ stream_name)

# 2. Generating training stream

project_path = "data_streams/base_detector_sine1_gradual_dde/" + stream_name + "/"
...
for detector in d:
    ...
    for tm in range(repeat_count):
        ...
        stream_generator = SINE1(concept_length=5000, noise_rate=0.1, transition_length=800, num_drifts=30,
                                 random_seed=tm)
...
f = open('dde_sine1_gradual.txt', 'a')
